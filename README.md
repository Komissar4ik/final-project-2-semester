...
Создать fullstack-веб-приложение с авторизацией, удаленным хранением данных и базовой функциональностью социальной сети.

## Целевая аудитория

Пользователи, которым нужен простой сервис для публикации коротких постов, поиска людей и общения через комментарии.
